...
[![](https://images.microbadger.com/badges/image/newtonsystems/tools-docker-grpc-tools:0.2.5.svg)](https://microbadger.com/images/newtonsystems/tools-docker-grpc-tools:0.2.5 "Get your own image badge on microbadger.com")

[![](https://images.microbadger.com/badges/version/newtonsystems/tools-docker-grpc-tools:0.2.5.svg)](https://microbadger.com/images/newtonsystems/tools-docker-grpc-tools:0.2.5 "Get your own version badge on microbadger.com")
...
-    [`v0.2.5`, `v0.2.4 (avoid)`, `v0.2.3`, `v0.2.2`, `v0.2.1`, `v0.2.0`, `latest` (/Dockerfile*)](https://github.com/newtonsystems/devops/blob/master/tools/docker-grpc-tools/Dockerfile)
